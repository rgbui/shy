...
import { Row, Col } from 'rich/component/grid';
    ...
    render() {
        return <div className='shy-ws-members'>
            <div className='shy-ws-memeber-invitation'>
                ...
                <Row><Col span={16}><Input></Input></Col><Col align='start' span={8}><Button onClick={e => this.createInvite()} ghost>{surface.workspace.inviteUrl ? '复制链接' : '创建链接'}</Button></Col></Row>
            </div>
