...
export var UserChannel = observer(function () {
    ...
    function mousedownRoom(channel, room) {
        userChannelStore.currentRoom = room;
        userChannelStore.currentChannel = channel;
    }
        ...
        return <div className="shy-user-channel-communicate">
            ...
            {userChannelStore.channels.map(c => {
                ...
                if (room.users.length == 2) {
                    ...
                    return <div key={c.id} onMouseDown={e => mousedownRoom(c, room)} className="shy-user-channel-communicate-room">
