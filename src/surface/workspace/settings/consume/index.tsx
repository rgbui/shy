...
export class ConsumeView extends React.Component {
    ...
    async load() {
        var r = await masterSock.get('/workspace/stats', { wsId: surface.workspace.id });
        if (r?.ok) {
            this.userDayStats = r.data.stats || null;
        }
    ...
    renderMasterCost() {
        return <div className="min-h-200">
            ...
            <div className="shy-page-order-list">
                <table>
                    <thead><tr><th><S>类别</S></th><th><S>消耗</S></th><th><S>核算</S></th><th><S>创建时间</S></th></tr></thead>
                    <tbody>
            ...
            <div>
                <div className="flex-center f-14 flex-wrap r-flex-fixed r-padding-15 r-gap-r-10 r-gap-b-10 r-round r-cursor r-item-hover-focus ">
                    ...
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{util.byteToString(this.userDayStats?.totalFileSize || 0)}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalComment || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalViewBrowse || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalDoc || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalBoard || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalDocCard || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalChannel || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalTable || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalRowCount || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalBookmark || 0}</div>
                    </div>
                    <div>
                        ...
                        <div className="f-24 gap-t-10 flex-center">{this.userDayStats?.totalTag || 0}</div>
                    </div>
                </div>
            </div>
