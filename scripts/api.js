...
push('/ws/channel/send', '{ sockId?: string,wsId?: string,roomId: string,content?: string,replyId?: string, files?:any[]}', 'SockResponse<{id:string,seq:number,createDate:Date}>', ['put'])
