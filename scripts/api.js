...
push(`/page/query/elementUrl`, `{elementUrl?:string}`, `LinkPageItem`, ['get']);
...
push('/view/snap/query/readonly','{wsId?:string, elementUrl: string}', 'SockResponse<{content:string,operates:any[]}>', ['get'])
