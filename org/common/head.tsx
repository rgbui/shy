                ...
                <div className="shy-site-head-navs-pop visible pos w-500 max-vw90 flex-top padding-10 " style={{ width: 520, top: 40, left: 10 }}>
                    ...
                    <div className="w40">
                        ...
                        <div className="r-padding-h-5 r-gap-h-5 r-padding-l-10     r-round r-cursor r-item-hover r-flex r-text-1 f-14">
                            ...
                            <a href={UrlRoute.getUrl("product/datatable")}><span className="size-24 flex-center gap-r-5" style={getTypeColor('datatable')}><Icon size={24} icon={{ name: 'byte', code: 'trace' }}></Icon></span><span className="text bold"><S>数据表</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='计划-名词'>计划</S></span></a>
                            <a href={UrlRoute.getUrl("product/whiteboard")} ><span className="size-24 flex-center gap-r-5" style={getTypeColor('whiteboard')}><Icon size={24} icon={{ name: 'bytedance-icon', code: 'enter-the-keyboard' }}></Icon></span><span className="text bold"><S>白板</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='绘图-名词'>创作</S></span></a>
                            <a href={UrlRoute.getUrl("product/ppt")} ><span className="size-24 flex-center gap-r-5" style={getTypeColor('ppt')}><Icon size={24} icon={DocCardsSvg}></Icon></span><span className="text bold"><S>PPT</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='表达-名词'>表达</S></span></a>

                        </div>
                        <div className="remark f-14   padding-l-10 gap-t-10  gap-b-10 bold-500"><S>自定义社交网络</S></div>
                        <div className="r-padding-h-5  r-gap-h-5  r-padding-l-10    r-round r-cursor r-item-hover r-flex r-text-1 f-14">
                            <a href={UrlRoute.getUrl("product/channel")} ><span className="size-24 flex-center gap-r-5" style={getTypeColor('channel')}><Icon size={24} icon={BoardToolFrameSvg}></Icon></span><span className="text bold"><S>频道</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='沟通-名词'>沟通</S></span></a>
                            <a href={UrlRoute.getUrl("product/channel")} ><span className="size-24 flex-center gap-r-5" style={getTypeColor('friends-circle')}><Icon size={24} icon={{ name: 'bytedance-icon', code: 'friends-circle' }}></Icon></span><span className="text bold"><S>社群</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='互动-名词'>互动</S></span></a>
                        </div>
                    </div>
                </div>
            </div>
