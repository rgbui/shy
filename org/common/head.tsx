                ...
                <div className="shy-site-head-navs-pop visible pos w-500 max-vw90 flex-top padding-10 " style={{ width: 520, top: 40, left: 10 }}>
                    ...
                    <div className="w40">
                        ...
                        <div className="r-padding-h-5 r-gap-h-5 r-padding-l-10     r-round r-cursor r-item-hover r-flex r-text-1 f-14">
                            ...
                            <a href={UrlRoute.getUrl("product/datatable")}><span className="size-24 flex-center gap-r-5" style={getTypeColor('datatable')}><Icon size={22} icon={{ name: 'byte', code: 'table' }}></Icon></span><span className="text bold"><S>数据表</S></span><span className="remark flex-auto flex-end padding-r-10"><S text='计划-名词'>计划</S></span></a>
